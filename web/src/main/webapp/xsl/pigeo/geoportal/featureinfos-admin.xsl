...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:template mode="script" match="/" priority="2">
    	...
    	<script type="text/javascript" src="{$widgetPath}/jean/GeoNetwork/admin/FeatureinfosManagerPanel.js"></script>
		...
		<script type="text/javascript" language="JavaScript">
			...
			Ext.onReady(function(){
				...
				var manager = new GeoNetwork.admin.FeatureinfosManagerPanel({
					renderTo		: 	'manager',
					catalogue		: 	catalogue,
					autoWidth 		: 	true,
