...
See the `groups documentation <http://geonetwork-opensource.org/manuals/2.10.3/eng/users/admin/usersandgroups/index.html#creating-new-user-groups>`_ on |gn| documentation.
...
See the `User Profiles documentation <http://geonetwork-opensource.org/manuals/2.10.3/eng/users/admin/usersandgroups/index.html#creating-new-users>`_ on |gn| documentation.
...
See the `ownership transfer <http://geonetwork-opensource.org/manuals/2.10.3/eng/users/managing_metadata/ownership/index.html#transfer-ownership>`_ on |gn| documentation.
...
See the `privileges <http://geonetwork-opensource.org/manuals/2.10.3/eng/users/managing_metadata/ownership/index.html#setting-privileges-on-a-metadata-record>`_ on |gn| documentation.
