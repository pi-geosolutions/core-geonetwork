...
manual = u'Editor & Administrator Manual'
...
latex_documents = [
  ('index', 'RiskManagementGeoportal-Burundi-EditorManual.tex', u'Geoportal for Risk Management for Burundi, Editor and Administrator Manual',
