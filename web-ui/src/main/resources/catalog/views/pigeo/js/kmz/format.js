(function() {
  ...
  ol.format.KML.createNameStyleFunction_ = function(foundStyle, name) {
    ...
    if (foundStyle.getText() !== null) {
      ...
      textStyle = angular.copy(foundText);
      ...
      textStyle = angular.copy(ol.format.KML.DEFAULT_TEXT_STYLE_);
    }
